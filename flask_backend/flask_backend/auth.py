...
# This function handles login requests generated by frontend and sets session to logged_in if request is valid
...
# This function handles registration requests generated by frontend and creates a new user if request is valid
...
# This function sets the status of user to verified if the email was confirmed
...
# This function handles logout requests generated by frontend and clears the session
